        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
                ...
                <div className="details">
                  ...
                  <h3>
                    <Link to="/blog-details">
                      Lorem ipsum dolor sit amet Lorem dolor sit amet sed do
                      eiusmod tempor.
                    </Link>
                  </h3>
              ...
              <div
                className="single-blog-inner style-quote text-center"
                style={{
                  background: "url(" + publicUrl + "assets/img/blog/4.png)",
                }}
              >
                <div className="details">
                  <div className="quote-thumb">
                    <img
                      src={publicUrl + "assets/img/icon/quote.png"}
                      alt="img"
                    />
                  </div>
                  <h3>
                    <Link to="/blog-details">
                      “Lorem ipsum dolor sit amet, consectetur et adipisicing
                      eiLorem ipsum dolor sit amet, consectetur elit”
                    </Link>
                  </h3>
                  <ul className="meta-inner">
                    <li>
                      <img
                        src={publicUrl + "assets/img/icon/4.png"}
                        alt="img"
                      />{" "}
                      By Admin
                    </li>
