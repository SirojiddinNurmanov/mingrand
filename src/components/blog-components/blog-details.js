                ...
                <div className="single-blog-inner bg-none">
                  ...
                  <div className="details p-0 pt-3">
                    ...
                    <blockquote className="blockquote">
                      <img
                        src={publicUrl + "assets/img/icon/7.png"}
                        alt="img"
                      />
                      <p>
                  ...
                  <div className="meta">
                    <div className="row">
                      <div className="col-sm-6">
                        <div className="tags">
                          <Link to="#">Treands</Link>
                          <Link to="#">Inttero</Link>
                          <Link to="#">Estario</Link>
                        </div>
                      </div>
                  ...
                  <form className="blog-comment-form">
                    <div className="section-title style-small mb-4 mt-5">
                      ...
                      <p>
                        Your Email addres not be published adipisicing elit,
                        sed*
                      </p>
                    </div>
                    <div className="row custom-gutters-20">
                      ...
                      <div className="col-12">
                        <label className="input-check-e">
                          <input type="checkbox" />
                          Save my name , email, website for the next time
                          comment
                        </label>
                      </div>
