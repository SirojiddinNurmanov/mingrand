            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-product-wrap style-2">
                ...
                <div className="product-details-inner">
                  ...
                  <p>
                    Lorem ipsum dolor consectetur iicing elit, sed do eius Lorem
                    ipsum dolo amet, costur adipisicing eiusmod.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="single-product-wrap style-2">
                ...
                <div className="product-details-inner">
                  ...
                  <h4>
                    <Link to="/blog-details">Villa House</Link>
                  </h4>
                  <p>
                    Lorem ipsum dolor consectetur iicing elit, sed do eius Lorem
                    ipsum dolo amet, costur adipisicing eiusmod.
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-product-wrap style-2">
                ...
                <div className="product-details-inner">
                  ...
                  <h4>
                    <Link to="/blog-details">Beach Side House</Link>
                  </h4>
                  <p>
                    Lorem ipsum dolor consectetur iicing elit, sed do eius Lorem
                    ipsum dolo amet, costur adipisicing eiusmod.
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-product-wrap style-2">
                ...
                <div className="product-details-inner">
                  ...
                  <h4>
                    <Link to="/blog-details">Hotel Apartment</Link>
                  </h4>
                  <p>
                    Lorem ipsum dolor consectetur iicing elit, sed do eius Lorem
                    ipsum dolo amet, costur adipisicing eiusmod.
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-product-wrap style-2">
                ...
                <div className="product-details-inner">
                  ...
                  <h4>
                    <Link to="/blog-details">Farm House</Link>
                  </h4>
                  <p>
                    Lorem ipsum dolor consectetur iicing elit, sed do eius Lorem
                    ipsum dolo amet, costur adipisicing eiusmod.
