          ...
          {/* <div className="widget widget-author text-center">
                ...
                <div className="details">
                  ...
                  <ul>
                    ...
                    <li><Link to="#"><i className="fab fa-linkedin-in" aria-hidden="true" /></Link></li>
                    <li><Link to="#"><i className="fab fa-instagram" aria-hidden="true" /></Link></li>
            ...
            <div className="widget-instagram-inner">
              <div className="row custom-gutters-10">
                ...
                <div className="col-4">
                  <div className="thumb">
                    <img
                      src={publicUrl + "assets/img/instagram/7.png"}
                      alt="img"
                    />
                    <i className="fab fa-instagram" />
                  </div>
                ...
                <div className="col-4">
                  <div className="thumb">
                    <img
                      src={publicUrl + "assets/img/instagram/8.png"}
                      alt="img"
                    />
                    <i className="fab fa-instagram" />
                  </div>
                ...
                <div className="col-4">
                  <div className="thumb">
                    <img
                      src={publicUrl + "assets/img/instagram/9.png"}
                      alt="img"
                    />
                    <i className="fab fa-instagram" />
                  </div>
