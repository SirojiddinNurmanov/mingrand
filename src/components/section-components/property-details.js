              ...
              <div className="row">
                ...
                <div className="col-lg-5 text-lg-right">
                  ...
                  <div className="btn-wrap">
                    <Link className="btn btn-base btn-sm" to="#">
                      BUILD
                    </Link>
                    <Link className="btn btn-blue btn-sm" to="#">
                      BUY
                    </Link>
                    <Link className="btn btn-blue btn-sm" to="#">
                      RENT
              ...
              <div className="single-property-details-inner">
                ...
                <div className="single-property-grid">
                  ...
                  <div className="property-map">
                    <iframe
                      title="iframe"
                      src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d198059.49240377638!2d-84.68048827338674!3d39.13652252762691!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1615660592820!5m2!1sen!2sbd"
                    />
                  </div>
                </div>
                <div className="single-property-grid">
                                        ...
                                        <div className="media-left">
                                            <div className="thumb">
                                                <img
                                                    src={
                                                        publicUrl +
                                                        "assets/img/project-single/9.png"
                                                    }
                                                    alt="img"
                                                />
                                            </div>
                                        ...
                                        <div className="media-left">
                                            <div className="thumb">
                                                <img
                                                    src={
                                                        publicUrl +
                                                        "assets/img/project-single/10.png"
                                                    }
                                                    alt="img"
                                                />
                                            </div>
                                        ...
                                        <div className="media-left">
                                            <div className="thumb">
                                                <img
                                                    src={
                                                        publicUrl +
                                                        "assets/img/project-single/11.png"
                                                    }
                                                    alt="img"
                                                />
                                            </div>
                ...
                {/* <div className="single-property-grid">
                                    ...
                                    <img
                                        src={
                                            publicUrl +
                                            "assets/img/project-single/7.png"
                                        }
                                        alt="img"
                                    />
                                </div> */}
